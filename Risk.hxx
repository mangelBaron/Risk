...
#include "Risk.h"
  ...
  void Risk::inicializar(){
    ...
    //TARJETAS
      ...
      tarjetas.push_back(Tarjeta{1, "Alaska", 1, 0});
      tarjetas.push_back(Tarjeta{2, "Alberta", 5, 0});
      tarjetas.push_back(Tarjeta{3, "America Central", 10, 0});
      tarjetas.push_back(Tarjeta{4, "Estados Unidos Orientales", 1, 0});
      tarjetas.push_back(Tarjeta{5, "Groenlandia", 5, 0});
      tarjetas.push_back(Tarjeta{6, "Territorio Noroccidental", 10, 0});
      tarjetas.push_back(Tarjeta{7, "Ontario", 1, 0});
      tarjetas.push_back(Tarjeta{8, "Quebec", 5, 0});
      tarjetas.push_back(Tarjeta{9, "Estado Unidos Occidentales", 10, 0});
      tarjetas.push_back(Tarjeta{10, "Gran Bretaña", 1, 0});
      tarjetas.push_back(Tarjeta{11,"Islandia", 5, 0});
      tarjetas.push_back(Tarjeta{12, "Europa del Norte", 10, 0});
      tarjetas.push_back(Tarjeta{13, "Escandinavia", 1, 0});
      tarjetas.push_back(Tarjeta{14, "Europa del sur", 5, 0});
      tarjetas.push_back(Tarjeta{15, "Ucrania", 10, 0});
      tarjetas.push_back(Tarjeta{16, "Europa occidental", 1, 0});
      tarjetas.push_back(Tarjeta{17, "Afghanistan", 5, 0});
      tarjetas.push_back(Tarjeta{18, "China", 10, 0});
      tarjetas.push_back(Tarjeta{19, "India", 1, 0});
      tarjetas.push_back(Tarjeta{20, "Irkutsk", 5, 0});
      tarjetas.push_back(Tarjeta{21, "Japon", 10, 0});
      tarjetas.push_back(Tarjeta{22, "Kamchatka", 1, 0});
      tarjetas.push_back(Tarjeta{   23, "Medio Oriente", 5, 0});
      tarjetas.push_back(Tarjeta{24, "Mongolia", 10, 0});
      tarjetas.push_back(Tarjeta{25, "Siam", 1, 0});
      tarjetas.push_back(Tarjeta{26, "Siberia", 5, 0});
      tarjetas.push_back(Tarjeta{27, "Ural", 10, 0});
      tarjetas.push_back(Tarjeta{28, "Yakutsk", 1, 0});
      tarjetas.push_back(Tarjeta{29, "Argentina", 5, 0});
      tarjetas.push_back(Tarjeta{30, "Brasil", 10, 0});
      tarjetas.push_back(Tarjeta{31, "Peru", 1, 0});
      tarjetas.push_back(Tarjeta{32, "Venezuela", 5, 0});
      tarjetas.push_back(Tarjeta{33, "Congo", 10, 0});
      tarjetas.push_back(Tarjeta{34, "Africa Oriental", 1, 0});
      tarjetas.push_back(Tarjeta{35, "Egipto", 5, 0});
      tarjetas.push_back(Tarjeta{36, "Madagascar", 10, 0});
      tarjetas.push_back(Tarjeta{37, "Africa del Norte", 1, 0});
      tarjetas.push_back(Tarjeta{38, "Africa del Sur", 5, 0});
      tarjetas.push_back(Tarjeta{39, "Australia Oriental", 10, 0});
      tarjetas.push_back(Tarjeta{40, "Indonesia", 1, 0});
      tarjetas.push_back(Tarjeta{41, "Nueva Guinea", 5, 0});
      tarjetas.push_back(Tarjeta{42, "Australia occidental", 10, 0});
